/**
 * Campfire Widget - Local Chat Server
 * 
 * This server connects to Twitch chat and broadcasts events to the widget.
 * Run this locally while streaming to enable real-time chat integration.
 * 
 * Setup:
